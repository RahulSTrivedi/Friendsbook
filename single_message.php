...
<html lang="en" dir="ltr">
  ...
  <body>
	  ...
	  <br>
		...
		<div id="timeline">
			<br>	
			<h2>You & <?php echo $otherpersonname; ?></h2>  <!--Dont forget to write echo-->
			<br>
			...
			// this query selects all between senderid and userid							
			$query  = "SELECT * FROM messages WHERE (sender_id='$user_id' AND reciever_id='$otherpersonid') OR (sender_id='$otherpersonid' AND reciever_id='$user_id')  ORDER BY 1 DESC";
			...
			{
			echo "<div id='messagethread1' style='padding: 2px;'>";	// this controls background	
			echo "<img src='images/$otherpersonimage' width='30'  height='30' style='float: left;  border-radius: 30px'>";// this controls image
			}
			else
			{
